  ...
  function applyFilters() {
    filteredFests = festivals.filter((fest) => {
      ...
      if (selectedMonth !== "전체") {
        ...
        if (festMonth !== selectedMonthNumber.toString().padStart(2, "0"))
          return false;
      }
      ...
      // 지역 필터링
      const selectedRegions = Object.keys(regionsChecked).filter(
        (region) => regionsChecked[region],
      );
      ...
      return selectedRegions.some((region) =>
        festRegion.includes(regionNameMap[region]),
      );
    });
    ...
    if (sortBy === "latest") {
      filteredFests.sort(
        (a, b) =>
          new Date(b.FEST_PERIOD.split(" ~ ")[0]) -
          new Date(a.FEST_PERIOD.split(" ~ ")[0]),
      );
...
<main class="main-content">
  ...
  <div class="content">
    <div class="d-flex justify-content-center align-items-center my-3">
      <button class="btn btn-white me-3" on:click={() => changeYear(-1)}
        ><strong>&lt;</strong></button
      >
      <h4 class="fw-bold">{currentYear}년</h4>
      <button class="btn btn-white ms-3" on:click={() => changeYear(1)}
        ><strong>&gt;</strong></button
      >
    </div>
    ...
    <div class="d-flex justify-content-center flex-wrap">
      <button
        class="btn rounded-circle me-4 all-month-select {selectedMonth ===
        '전체'
          ? 'btn-dark text-white'
          : 'btn-outline-dark'}"
      ...
      {#each months as month}
        <button
          class="btn rounded-circle me-4 month-select {selectedMonth === month
            ? 'btn-dark text-white'
            : 'btn-outline-dark'}"
    ...
    <div class="container mt-4">
      <div
        class="p-2 border shadow-sm rounded"
        style="box-shadow: 0 0 4px rgba(0, 0, 0, 0.25);"
      >
              ...
              <td class="text-center">
                <div class="form-check">
                  <input
                    ...
                    type="checkbox"
                    id="nationwide"
                    bind:checked={nationwideChecked}
                    on:change={toggleNationwide}
                  />
              ...
              <td class="text-center">
                <div class="form-check">
                  <input
                    ...
                    type="checkbox"
                    id="seoul"
                    bind:checked={regionsChecked.seoul}
                    on:change={() => toggleRegion("seoul")}
                  />
              ...
              <td class="text-center">
                <div class="form-check">
                  <input
                    ...
                    type="checkbox"
                    id="incheon"
                    bind:checked={regionsChecked.incheon}
                    on:change={() => toggleRegion("incheon")}
                  />
              ...
              <td class="text-center">
                <div class="form-check">
                  <input
                    ...
                    type="checkbox"
                    id="daejeon"
                    bind:checked={regionsChecked.daejeon}
                    on:change={() => toggleRegion("daejeon")}
                  />
              ...
              <td class="text-center">
                <div class="form-check">
                  <input
                    ...
                    type="checkbox"
                    id="daegu"
                    bind:checked={regionsChecked.daegu}
                    on:change={() => toggleRegion("daegu")}
                  />
              ...
              <td class="text-center">
                <div class="form-check">
                  <input
                    ...
                    type="checkbox"
                    id="gwangju"
                    bind:checked={regionsChecked.gwangju}
                    on:change={() => toggleRegion("gwangju")}
                  />
              ...
              <td class="text-center">
                <div class="form-check">
                  <input
                    ...
                    type="checkbox"
                    id="busan"
                    bind:checked={regionsChecked.busan}
                    on:change={() => toggleRegion("busan")}
                  />
              ...
              <td class="text-center">
                <div class="form-check">
                  <input
                    ...
                    type="checkbox"
                    id="ulsan"
                    bind:checked={regionsChecked.ulsan}
                    on:change={() => toggleRegion("ulsan")}
                  />
              ...
              <td class="text-center">
                <div class="form-check">
                  <input
                    ...
                    type="checkbox"
                    id="gyeonggi"
                    bind:checked={regionsChecked.gyeonggi}
                    on:change={() => toggleRegion("gyeonggi")}
                  />
              ...
              <td class="text-center">
                <div class="form-check">
                  <input
                    ...
                    type="checkbox"
                    id="gangwon"
                    bind:checked={regionsChecked.gangwon}
                    on:change={() => toggleRegion("gangwon")}
                  />
              ...
              <td class="text-center">
                <div class="form-check">
                  <input
                    ...
                    type="checkbox"
                    id="chungbuk"
                    bind:checked={regionsChecked.chungbuk}
                    on:change={() => toggleRegion("chungbuk")}
                  />
              ...
              <td class="text-center">
                <div class="form-check">
                  <input
                    ...
                    type="checkbox"
                    id="chungnam"
                    bind:checked={regionsChecked.chungnam}
                    on:change={() => toggleRegion("chungnam")}
                  />
              ...
              <td class="text-center">
                <div class="form-check">
                  <input
                    ...
                    type="checkbox"
                    id="gyeongbuk"
                    bind:checked={regionsChecked.gyeongbuk}
                    on:change={() => toggleRegion("gyeongbuk")}
                  />
              ...
              <td class="text-center">
                <div class="form-check">
                  <input
                    ...
                    type="checkbox"
                    id="gyeongnam"
                    bind:checked={regionsChecked.gyeongnam}
                    on:change={() => toggleRegion("gyeongnam")}
                  />
              ...
              <td class="text-center">
                <div class="form-check">
                  <input
                    ...
                    type="checkbox"
                    id="jeonbuk"
                    bind:checked={regionsChecked.jeonbuk}
                    on:change={() => toggleRegion("jeonbuk")}
                  />
              ...
              <td class="text-center">
                <div class="form-check">
                  <input
                    ...
                    type="checkbox"
                    id="jeonnam"
                    bind:checked={regionsChecked.jeonnam}
                    on:change={() => toggleRegion("jeonnam")}
                  />
              ...
              <td class="text-center">
                <div class="form-check">
                  <input
                    ...
                    type="checkbox"
                    id="jeju"
                    bind:checked={regionsChecked.jeju}
                    on:change={() => toggleRegion("jeju")}
                  />
              ...
              <td class="text-center">
                <div class="form-check">
                  <input
                    ...
                    type="checkbox"
                    id="sejong"
                    bind:checked={regionsChecked.sejong}
                    on:change={() => toggleRegion("sejong")}
                  />
          ...
          <div class="col-md-3 mb-4">
            <div class="fest-card text-truncate">
              <a use:link href={`/FestView/${festival.FEST_IDX}`}>
                <img
                  src={festival.FEST_URL}
                  alt={festival.FEST_NM}
                  class="img-fluid rounded-10 fest-image"
                />
              </a>
      ...
      <ul class="pagination pagination-sm">
        <li class="page-item {currentPageNumber === 1 ? 'disabled' : ''}">
          <a
            class="page-link"
            href="#"
            on:click|preventDefault={() => (currentPageNumber = 1)}>&laquo;</a
          >
        </li>
        {#each Array.from({ length: Math.ceil(filteredFests.length / itemsPerPage) }, (_, i) => i + 1) as page}
          <li class="page-item {page === currentPageNumber ? 'active' : ''}">
            <a
              class="page-link"
              href="#"
              on:click|preventDefault={() => (currentPageNumber = page)}
              >{page}</a
            >
          </li>
        {/each}
        <li
          class="page-item {currentPageNumber ===
          Math.ceil(filteredFests.length / itemsPerPage)
            ? 'disabled'
            : ''}"
        >
          <a
            ...
            on:click|preventDefault={() =>
              (currentPageNumber = Math.ceil(
                filteredFests.length / itemsPerPage,
              ))}>&raquo;</a
          >
        </li>
      </ul>
